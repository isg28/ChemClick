                ...
                <div className='lesson-three-point-one-box'>
                    <div className='lesson-three-point-one-box-innercont'>
                        ...
                        <div className="submit-feedback-container">
                            {!isAnswerCorrect && (
                                <button className='lesson-three-point-one-submit' onClick={handleSubmitAnswer}>Submit Answer</button>
                            )}
                            {isAnswerCorrect && (
                                <button className='lesson-three-point-one-next' onClick={handleNextQuestion}>Next Question</button>
                            )}
